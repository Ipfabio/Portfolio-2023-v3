...
------
    <main id="main" class="site-main">
		...
		<section class="site-section section-hello" id="intro">
			<div class="container">
				<h2>Bienvenido</h2>
				<p class="section-subtitle"><span>Explora nuestro mundo</span></p>
				<div class="row">
					<div class="col-sm-4">
						<div class="main-service text-right">
							...
							<h3>Cumplir Deadlines</h3>
							<p>Su fecha límite es el valor más importante para nosotros. Nos enfocammos en que el trabajo se realice perfectamente antes de la fecha límite.</p>
						</div><!-- /.main-service -->
                        <div class="main-service text-right">
                            <div class="rectangle">
                            ...
                            <p>Estamos completamente a disposición para revisar sus preguntas y recibir comentarios lo antes posible.</p>
                        </div><!-- /.main-service -->
					</div>
					<div class="col-sm-4">
					...
					<div class="col-sm-4">
                        <div class="main-service text-left">
                            ...
                            <p>Probamos todo para asegurarnos de que su proyecto sea completamente funcional, compatible con todos los navegadores y cumpla con sus especificaciones.</p>
                        </div><!-- /.main-service -->
						<div class="main-service text-left">
							<div class="rectangle">
							...
							<h3>IP</h3>
							<p>Desarrollamos productos y experiencias digitales significativos que importan con pensamiento de diseño y artesanía creativa.</p>
						</div><!-- /.main-service -->
					</div>
				</div>
			</div>
...
------
        <section class="site-section section-about text-center" id="about">
            <div class="container">
                <h2>Acerca de los trabajos</h2>
                <p class="section-subtitle"><span>Nuestro objetivo es construir productos y servicios.</span></p>
                <div class="row">
                    <div class="col-sm-3 col-xs-6">
                        <div class="feature-about">
                            ...
                            <h3>Diseño Web</h3>
                            <p>Nuestro enfoque para el diseño de sitios web es crear un sitio web que fortalezca la marca de su empresa y al mismo tiempo garantice facilidad de uso y simplicidad para su audiencia.</p>
                        </div><!-- /.feature-about -->
                    </div>                    
                    <div class="col-sm-3 col-xs-6">
                        <div class="feature-about">
                            ...
                            <p>El proceso de desarrollo web implica tomar los elementos gráficos definidos en el proceso de diseño y codificarlos en un tema personalizado.</p>
                        </div><!-- /.feature-about -->
                    </div>                    
                    <div class="col-sm-3 col-xs-6">
                        <div class="feature-about">
                    ...
                    <div class="col-sm-3 col-xs-6">
                        <div class="feature-about">
                            ...
                            <h3>SOCIAL MEDIA</h3>
                            <p>Es importante para nosotros mantener un registro de nuestro crecimiento y el de nuestros proyectos</p>
                        </div><!-- /.feature-about -->
                    </div>
                </div>
            </div>
